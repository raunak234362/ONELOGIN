                          ...
                          <div className='flex flex-row gap-4'>
                            <select
                              ...
                              onChange={e => {
                                ...
                                fetchUserViaGroup(e.target.value, setTeamLeadUsers);
                              }}
                              required
                          ...
                          <div className='flex flex-row gap-4'>
                            <select
                              ...
                              onChange={e => {
                                ...
                                fetchUserViaGroup(e.target.value, setModelerUsers);
                              }}
                              required
                              className=' w-1/3 mt-5 border border-gray-300 rounded-md px py-2'
                            >
                          ...
                          <div className='flex flex-row gap-4'>
                            <select
                              ...
                              onChange={e => {
                                ...
                                fetchUserViaGroup(e.target.value, setCheckerUsers);
                              }}
                              required
                              className=' w-1/3 mt-5 border border-gray-300 rounded-md px py-2'
                            >
                          ...
                          <div className='flex flex-row gap-4'>
                            <select
                              ...
                              onChange={e => {
                                ...
                                fetchUserViaGroup(e.target.value, setErectorUsers);
                              }}
                              required
                              className=' w-1/3 mt-5 border border-gray-300 rounded-md px py-2'
                            >
                          ...
                          <div className='flex flex-row gap-4'>
                            <select
                              ...
                              onChange={e => {
                                ...
                                fetchUserViaGroup(e.target.value, setDetailerUsers);
                              }}
                              required
                              className=' w-1/3 mt-5 border border-gray-300 rounded-md px py-2'
                            >

                ...
                <div>
                  {usertask?.status === 'pending' && (
                    <button
                      ...
                      className="bg-green-500 flex justify-end text-white py-2 px-6 rounded-full hover:bg-green-700 transition duration-300"
                    >
                      Accept Task
                    </button>
                  )}
                    ...
                    <td className="py-2 px-4 border">
                      ...
                      {task === index && (
                        <div className="absolute right-0 text-left bg-white p-5 rounded-xl shadow-md">
                          <h1 className="text-center text-2xl mb-4 font-semibold my-10">
                            {item?.title}
                          </h1>
